...
function Educational() {
  return (
    ...
    >
       ...
       <p className='dark:text-gray-400'>CGPA : 1st Semester <span className='text-cyan-700'>8.69</span></p>
       <p className='dark:text-gray-400'>CGPA : 2nd Semester <span className='text-cyan-700'>8.36</span></p>
       </div>
       {/* 12th */}
       <div className='mt-10'>
       <hr class="h-0.5 my-8 bg-gray-200 border-0 dark:bg-slate-300"></hr>
